...
import 'package:hilal_villa/api_services/api_provider.dart';
import 'package:hilal_villa/api_services/api_utils.dart';
import 'package:hilal_villa/common/constants.dart';
import 'package:hilal_villa/common/spacing.dart';
import 'package:hilal_villa/features/admin/screens/create_staff.dart';
import 'package:hilal_villa/features/admin/screens/issue_details_screen.dart';
import 'package:hilal_villa/features/admin/screens/room_change_requests_screen.dart';
import 'package:hilal_villa/features/admin/screens/staff_display_screen.dart';
import 'package:hilal_villa/features/student/screens/hostel_fees.dart';
import 'package:hilal_villa/features/student/screens/profile_screen.dart';
import 'package:hilal_villa/features/student/screens/raise_issue_screen.dart';
import 'package:hilal_villa/features/student/screens/room_availability.dart';
import 'package:hilal_villa/models/student_info_model.dart';
import 'package:hilal_villa/theme/colors.dart';
import 'package:hilal_villa/theme/text_theme.dart';
import 'package:hilal_villa/widgets/category_card.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> fetchStudentDetails(String emailId) async {
    try {
      ...
      final studentInfo = await apiProvider.getRequest(
        '${ApiUrls.studentDetails}$emailId',
      );
      ...
      if (studentInfo.statusCode == 200) {
        ...
        ApiUrls.phoneNumber =
            studentInfoModel!.result[0].studentProfileData.phoneNumber
                .toString();
        ApiUrls.roomNumber =
            studentInfoModel!.result[0].studentProfileData.roomNumber
                .toString();
        ApiUrls.username =
        ...
        setState(() {
          _chartData = [
            ...
            ChartData(
              label: 'Pending',
              value:
                  (roomChangeChart['totalNumberRoomChangeRequest'] -
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.push(
                                ...
                                CupertinoPageRoute(
                                  builder:
                                      (context) => const RaiseIssueScreen(),
                                ),
                              );
                            },
                            child: Column(
                        ...
                        CategoryCard(
                          ...
                          onTap: () {
                            Navigator.push(
                              ...
                              CupertinoPageRoute(
                                builder:
                                    (context) => const RoomAvailabilityScreen(),
                              ),
                            );
                          },
                        ),
