...
import 'package:hilal_villa/common/app_bar.dart';
import 'package:hilal_villa/common/constants.dart';
import 'package:hilal_villa/common/spacing.dart';
import 'package:hilal_villa/features/student/screens/change_room_screen.dart';
import 'package:hilal_villa/models/room_availability_model.dart';
...
class _RoomAvailabilityScreenState extends State<RoomAvailabilityScreen> {
  ...
  Future<void> fetchData() async {
    try {
      ...
      final roomAvailability = await apiProvider.getRequest(
        ApiUrls.roomAvailability,
      );
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Column(
            children: [
              Image.asset(AppConstants.bed, height: 70.h, width: 70.w),
              Text(
                            ...
                            : InkWell(
                              onTap: () {
                                Navigator.push(
                                  ...
                                  CupertinoPageRoute(
                                    builder:
                                        (context) => const ChangeRoomScreen(),
                                  ),
                                );
                              },
                              child: Text(
